...
describe('default filter constant', () => {
    it('should be the value of LogType.Default', async () => {
        const expected = LogType.Default;

        const { entries, log } = createLogWithFilter(`default == ${JSON.stringify(expected)}`);
