...
describe('warn filter constant', () => {
    it('should be the value of LogType.Warn', async () => {
        const expected = LogType.Warn;

        const { entries, log } = createLogWithFilter(`warn == ${JSON.stringify(expected)}`);
