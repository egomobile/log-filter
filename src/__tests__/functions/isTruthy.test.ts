...
describe('isTruthy() filter function', () => {
    it.each(values)('should match if first argument is truthy', async (value) => {
        const { entries, log } = createLogWithFilter('isTruthy(arg0)');
